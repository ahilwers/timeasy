...
<#assign xKeycloakify={
    "messages": {},
    "pageId": "email-confirmation-error.ftl",
    "ftlTemplateFileName": "email-confirmation-error.ftl",
    "themeType": "login",
    "themeName": "Tailcloakify",
    "keycloakifyVersion": "11.8.42",
    "themeVersion": "1.1.17",
    "resourcesPath": ""
}>
...
<#macro addNonAutomaticallyGatherableMessagesToXKeycloakifyMessages>
    ...
    <#if requiredActions?? && requiredActions?is_enumerable>
      ...
      <script type="module" crossorigin="" src="${xKeycloakify.resourcesPath}/dist/assets/index-Kjc2dqvG.js"></script>
    </head>
